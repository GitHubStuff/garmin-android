package com.garmin.garminhealth.ui.settings.widget;
...
public class SettingsSpinner<T> extends LinearLayout
{
    ...
    private String getString(T selectedOption)
    {
        ...
        {
            return com.garmin.garminhealth.ui.settings.util.TextUtils.toTitleCase((String)selectedOption);
        }
        ...
        try
        {
            ...
            {
                return com.garmin.garminhealth.ui.settings.util.TextUtils.toTitleCase(mContext.getString(resId));
            }
        }
        catch(Exception e)
        {
        ...
        return com.garmin.garminhealth.ui.settings.util.TextUtils.toTitleCase(selectedOption.toString());
    }
